...
\membrodabancaiii{Prof. Dr. Sérgio Antônio Andrade de Freitas ,\\ UnB/FCTE} % Membro 3
...
\bibliography{tcctea/unbtex-example/referencias} % O estilo de citação é selecionado automaticamente
% ---
